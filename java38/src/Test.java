public class Test {
	public static void main(String[] args) {
		...
		System.out.println("SV1: "+ sv1.kiemTraThiDau());
		System.out.println("SV2: "+ sv2.kiemTraThiDau());
		System.out.println("SV3: "+ sv3.kiemTraThiDau());
		System.out.println("Kiểm tra cùng ngày sinh:");
		System.out.println("sv1 và sv2: "+ sv1.kiemTraNgaySinh(sv2));
		System.out.println("sv1 và sv3: "+ sv1.kiemTraNgaySinh(sv3));

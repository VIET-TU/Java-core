public class Test {
	public static void main(String[] args) {
		...
		System.out.println("Tên hãng sản xuất BP 3: "+boPhim3.layTenHangSanXuatPhim());
	
		System.out.println("BP1 giam 10%: "+ boPhim1.giaSauKhiKhuyenMai(10));
		System.out.println("BP2 giam 20%: "+ boPhim2.giaSauKhiKhuyenMai(20));
		System.out.println("BP3 giam 50%: "+ boPhim3.giaSauKhiKhuyenMai(50));
	}
}